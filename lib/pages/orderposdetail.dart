...
class OrderPosDetailPage extends StatefulWidget {
  static const routeName = '/orderposdetail';

  @override
  _OrderPosDetailPageState createState() => _OrderPosDetailPageState();
}

class _OrderPosDetailPageState extends State<OrderPosDetailPage> {
  ...
  Future _obtainOrderFuture() {
    return Provider.of<OrderData>(context, listen: false)
        .getCustomerPosDetails();
  }
  ...
  void _cancelposorder(String line_id) async {
    return showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('แจ้งเตือน'),
        content: Text('ต้องการยกเลิกรายการนี้ใช่หรือไม่'),
        actions: <Widget>[
          ElevatedButton(
            onPressed: () {
              Provider.of<OrderData>(context, listen: false)
                  .cancelPosOrder(line_id, 'ยกเลิก')
                  .then(
                (_) {
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content: Row(
