...
import 'package:ice_app_new/pages/dailytransfersuccess.dart';
...
class DailytransferPage extends StatefulWidget {
  static const routeName = '/dailytransfer';
  @override
  _DailytransferPageState createState() => _DailytransferPageState();
}

class _DailytransferPageState extends State<DailytransferPage>
  ...
  Widget _buidorderlist() {
    List<Products> products =
        Provider.of<ProductData>(context, listen: false).listproducttf();
    Widget productCards;
                          ...
                          setState(() {
                            ...
                            if (_countitemlist.isNotEmpty) {
                              _countitemlist.forEach((element) {
                                if (element.product_id == products[index].id) {
          ...
          ElevatedButton(
            onPressed: () async {
              bool res = await Provider.of<ProductData>(context, listen: false)
                  .addDailytransfer(_countitemlist);
              ...
              if (res == true) {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => DailytransfersuccessPage()));
              }
