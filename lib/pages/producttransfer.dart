...
import 'package:ice_app_new/widgets/producttransfer/producttransferitem.dart';
...
class ProductTransferPage extends StatefulWidget {
  static const routeName = '/producttransfer';
  @override
  _ProductTransferPageState createState() => _ProductTransferPageState();
}
...
class _ProductTransferPageState extends State<ProductTransferPage>
  ...
  Future _obtainOrderFuture() {
    ...
    return Provider.of<ProductData>(context, listen: false)
        .fetProductTransfer();
  }
  ...
  Widget _buidorderlist() {
      ...
      builder: (context, dataSnapshort) {
        if (dataSnapshort.connectionState == ConnectionState.waiting) {
          ...
          if (dataSnapshort.error != null) {
            ...
            return Container(child: ProductTransferItem());
          }
        }
      },
    );
    ...
    return RefreshIndicator(
      child: content,
      onRefresh: orders.fetProductTransfer,
    );
  }
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.of(context)
                      .pushNamed(CreateProductTransferPage.routeName);
                },
                child: Icon(
