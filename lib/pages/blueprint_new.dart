...
class BlueprintNewPage extends StatefulWidget {
  @override
  _BlueprintNewPageState createState() => _BlueprintNewPageState();
}

class _BlueprintNewPageState extends State<BlueprintNewPage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  //     // List<int> bytes = await getTicket();
  //     List<int> imageBytes =
  //         await imagePathToUint8List('assets/logo_bp_new.png');
  //     final result = await BluetoothThermalPrinter.writeBytes(imageBytes);
  //     print("Print $result");
  //   } else {
  //     //Hadnle Not Connected Senario
  //   }
  ...
  Future<List<int>> imagePathToUint8List(String path) async {
//converting to Uint8List to pass to printer
  ...
  Future<List<int>> getTicket() async {
    ...
    bytes += generator.text("เล็ก Shop",
        styles: PosStyles(
