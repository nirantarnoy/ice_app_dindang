...
class ScrapsuccessPage extends StatefulWidget {
  @override
  _ScrapsuccessPageState createState() => _ScrapsuccessPageState();
}

class _ScrapsuccessPageState extends State<ScrapsuccessPage> {
  @override
