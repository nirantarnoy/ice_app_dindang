...
import 'package:ice_app_new/widgets/product/scrap_item.dart';
...
class ScrapPage extends StatefulWidget {
  static const routeName = '/scrappage';
  @override
...
class _ScrapPageState extends State<ScrapPage> with TickerProviderStateMixin {
  ...
  Future _obtainOrderFuture() {
    ...
    return Provider.of<ProductData>(context, listen: false).fetScrap();
  }
      ...
      builder: (context, dataSnapshort) {
        if (dataSnapshort.connectionState == ConnectionState.waiting) {
          ...
          if (dataSnapshort.error != null) {
            ...
            return Container(child: ScrapItem());
            // return Center(
            //   child: Text('no'),
            // );
          }
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.of(context).pushNamed(CreateScrapPage.routeName);
                },
                child: Icon(
