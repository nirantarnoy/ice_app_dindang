...
class CreateorderNewPosPage extends StatefulWidget {
  static const routeName = '/createordernewpos';
  @override
  _CreateorderNewPosPageState createState() => _CreateorderNewPosPageState();
}

class _CreateorderNewPosPageState extends State<CreateorderNewPosPage> {
  ...
  Widget _buildproductList(List<ProductPos> products) {
    Widget productCards;
                                  ...
                                  Center(
                                    child: Column(
                                      children: [
                                        ...
                                        Text("${products[index].saleprice} B",
                                            style: TextStyle(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  Expanded(
                    ...
                    child: Container(
                      ...
                      height: 50,
                      child: Center(child: Text("สดหน้าบ้าน")),
                      color: customer_type == 0 ? Colors.green : Colors.grey,
                    ),
                  )),
                  Expanded(
                      child: GestureDetector(
                    ...
                    child: Container(
                      width: double.infinity,
                      height: 50,
                      child: Center(child: Text("เลือกลูกค้า")),
                      color: customer_type == 1 ? Colors.green : Colors.grey,
                    ),
                  )),
                ],
              ),
              ...
              Expanded(
                ...
                builder: (context, products, _) =>
                    _buildproductList(products.listproductpos),
              )),
              Container(
                child: Row(
                  children: [
