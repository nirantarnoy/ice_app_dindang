...
class CreateScrapPage extends StatefulWidget {
  static const routeName = '/createscrappage';
  @override
  _CreateScrapPageState createState() => _CreateScrapPageState();
}

class _CreateScrapPageState extends State<CreateScrapPage> {
  final TextEditingController _typeAheadController = TextEditingController();
  String selectedValue;
  String selectedValueName;
  int isuserconfirm = 0;
  List<AddscrapItem> orderItems = [];
