...
import 'package:ice_app_new/widgets/onhand/_onhand_item.dart';
...
class OnhandPage extends StatefulWidget {
  static const routeName = '/onhand';
  @override
  _OnhandPageState createState() => _OnhandPageState();
}

class _OnhandPageState extends State<OnhandPage> with TickerProviderStateMixin {
  var _isInit = true;
  ...
  Widget _buidorderlist() {
      ...
      builder: (context, dataSnapshort) {
        if (dataSnapshort.connectionState == ConnectionState.waiting) {
          ...
          if (dataSnapshort.error != null) {
            ...
            // return Text('xxxdfdfdf');
            return Container(child: OnhandItem());
          }
        }
      },
    );
    ...
    return RefreshIndicator(
      child: content,
      onRefresh: orders.fetProductAll,
    );
  }
