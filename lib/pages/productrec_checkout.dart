...
class ProductrecCheckoutPage extends StatefulWidget {
  static const routeName = '/productreccheckout';
  @override
  _ProductrecCheckoutPageState createState() => _ProductrecCheckoutPageState();
}

class _ProductrecCheckoutPageState extends State<ProductrecCheckoutPage> {
...
// end
  ...
  void _submitForm2(List<Addprodrec> listitems) async {
    ...
    bool issave = await Provider.of<ProductData>(context, listen: false)
        .addProdrec(listitems);
    if (issave == true) {
      String prod_rec_no =
          Provider.of<ProductData>(context, listen: false).prodrec_after_add;
