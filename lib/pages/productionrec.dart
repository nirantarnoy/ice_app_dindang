...
class ProductionRecPage extends StatefulWidget {
  static const routeName = '/productionrec';
  @override
  _ProductionRecPageState createState() => _ProductionRecPageState();
}

class _ProductionRecPageState extends State<ProductionRecPage>
  ...
  Future _obtainOrderFuture() {
    ...
    return Provider.of<ProductData>(context, listen: false).fetProductionRec();
  }
  ...
  Widget _buidorderlist() {
    ProductData orders = Provider.of<ProductData>(context, listen: false);
    Widget content;
    content = FutureBuilder(
      future: _orderFuture,
      builder: (context, dataSnapshort) {
        if (dataSnapshort.connectionState == ConnectionState.waiting) {
          ...
          if (dataSnapshort.error != null) {
            ...
            return Container(child: ProductionRecItem());
          }
        }
      },
    );
    ...
    return RefreshIndicator(
      child: content,
      onRefresh: orders.fetProductionRec,
    );
  }
