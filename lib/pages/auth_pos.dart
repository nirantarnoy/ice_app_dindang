...
class AuthPosPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _AuthPosPageState();
  }
}

class _AuthPosPageState extends State<AuthPosPage> {
  ...
  void _submitForm(Function loginpos) async {
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: new ElevatedButton(
                              ...
                              onPressed: () => _submitForm(users.loginpos)),
                        ),
                      ),
                      SizedBox(
                        height: 10.0,
