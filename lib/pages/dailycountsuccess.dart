...
class DailycountsuccessPage extends StatefulWidget {
  @override
  _DailycountsuccessPageState createState() => _DailycountsuccessPageState();
}

class _DailycountsuccessPageState extends State<DailycountsuccessPage> {
  @override
