...
class PlanData with ChangeNotifier {
  ...
  final String url_to_plan =
      ...
      "http://103.253.73.108/icesystemdindang/frontend/web/api/plan/listplan";
  final String url_to_add_plan =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/plan/addplan";
  final String url_to_delete_plan =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/plan/deleteplan";
  //  "http://192.168.1.120/icesystembp/frontend/web/api/order/deleteorderline";
  final String url_to_plan_by_customer =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/plan/listplanbycustomer";
  final String url_to_delete_plan_line =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/plan/deleteplanline";
