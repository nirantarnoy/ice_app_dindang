...
class TransferoutData with ChangeNotifier {
  final String url_to_out_list =
      //  "http://192.168.1.120/icesystembp/frontend/web/api/transfer/outlist";
      "http://103.253.73.108/icesystemdindang/frontend/web/api/transfer/outlistnew";
  final String url_to_in_list =
      //   "http://192.168.1.120/icesystembp/frontend/web/api/transfer/inlist";
      "http://103.253.73.108/icesystemdindang/frontend/web/api/transfer/inlist";
  //"http://103.253.73.108/icesystemdindang/frontend/web/api/customer/list";
  final String url_to_add_transfer =
      //   "http://192.168.1.120/icesystembp/frontend/web/api/transfer/inlist";
      "http://103.253.73.108/icesystemdindang/frontend/web/api/transfer/addtransfer";
  //"http://103.253.73.108/icesystemdindang/frontend/web/api/customer/list";
