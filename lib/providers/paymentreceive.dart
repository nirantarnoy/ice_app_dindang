...
class PaymentreceiveData with ChangeNotifier {
  final String url_to_payment_list =
      //   "http://192.168.1.120/icesystembp/frontend/web/api/paymentreceive/list";
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/list";
  final String url_to_payment_pos_list =
      //   "http://192.168.1.120/icesystembp/frontend/web/api/paymentreceive/list";
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/poslist";
  // "http://103.253.73.108/icesystemdindang/frontend/web/api/product/list";
  // final String url_to_add_payment =
  //     //    "http://192.168.1.120/icesystembp/frontend/web/api/paymentreceive/addpay";
  //     "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/addpay";
  final String url_to_add_payment2 =
      //    "http://192.168.1.120/icesystembp/frontend/web/api/paymentreceive/addpay";
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/addpay2";
  final String url_to_delete_payment_line =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/deletepay";
  //  "http://192.168.1.120/icesystembp/frontend/web/api/paymentreceive/deletepay";
  //
  //
  //
  final String url_to_payment_daily =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/paymentdaily";
  final String url_to_payment_history =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/paymenthistory";

  final String url_to_payment_history_cancel =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/paymentcancel";

  final String url_to_payment_pos_daily =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/paymentposdaily";

  final String url_to_payment_history_pos =
      "http://103.253.73.108/icesystemdindang/frontend/web/api/paymentreceive/paymenthistorypos";
  ...
  Future<dynamic> fetPaymentPosreceive(String customer_id) async {
    final Map<String, dynamic> filterData = {'customer_id': customer_id};
    print("find by customer is ${customer_id}");
    _isLoading = true;
    notifyListeners();
    try {
      http.Response response;
      response = await http.post(Uri.parse(url_to_payment_pos_list),
          headers: {'Content-Type': 'application/json'},
          body: json.encode(filterData));
  ...
  Future<dynamic> fetPaymentPosdaily() async {
    String user_id = '';
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    if (prefs.getString('user_id') != null) {
    ...
    print("find by user id is ${payData}");
    _isLoading = true;
    notifyListeners();
    try {
      http.Response response;
      response = await http.post(Uri.parse(url_to_payment_pos_daily),
          headers: {'Content-Type': 'application/json'},
          body: json.encode(payData));
      ...
      if (response.statusCode == 200) {
        ...
        List<Paymentdaily> data = [];
        // print('data length is ${res["data"].length}');
        print('data payment pos daily is ${res["data"]}');
  ...
  Future<dynamic> fetPaymenthistoryPos() async {
    String _user_id = "";
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    if (prefs.getString('user_id') != null) {
      _user_id = prefs.getString('user_id');
    }
    final Map<String, dynamic> filterData = {'user_id': _user_id};
    //  print("find by customer is ${customer_id}");
    _isLoading = true;
    notifyListeners();
    try {
      http.Response response;
      response = await http.post(Uri.parse(url_to_payment_history_pos),
          headers: {'Content-Type': 'application/json'},
          body: json.encode(filterData));
      ...
      if (response.statusCode == 200) {
        ...
        List<Paymenthistory> data = [];
        // print('data length is ${res["data"].length}');
        print('data payment pos is ${res["data"]}');
