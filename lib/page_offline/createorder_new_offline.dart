...
class CreateorderNewOfflinePage extends StatefulWidget {
  static const routeName = '/createordernewoffline';
  @override
  _CreateorderNewOfflinePageState createState() =>
      _CreateorderNewOfflinePageState();
}

class _CreateorderNewOfflinePageState extends State<CreateorderNewOfflinePage> {
  final TextEditingController _typeAheadController = TextEditingController();
  String selectedValue;
  String selectedValueName;
  int isuserconfirm = 0;
  List<Addorder> orderItems = [];
  List<CustomerProductPrice> list_product_offline = [];
  ...
  Widget _buildproductList(List<CustomerProductPrice> products) {
    Widget productCards;
        ...
        body: Container(
          ...
          child: Column(
            children: <Widget>[
                          ...
                          child: Consumer<CustomerData>(
                            builder: (context, _customer, _) => TypeAheadField(
                              ...
                              onSuggestionSelected: (items) {
                                print(
                                    'selected value is ${items.id.toString()}');
                                setState(() async {
                                  selectedValue = items.id.toString();
                                  selectedValueName = items.name;
                                  list_product_offline = await DbHelper.instance
                                      .findCustomerproduct(selectedValue);

                                  print(list_product_offline);
              ...
              Expanded(
                child: _buildproductList(list_product_offline),
              ),
              Container(
                child: Row(
                  children: [
