...
class OrderItemNewPos extends StatefulWidget {
  @override
  _OrderItemNewPosState createState() => _OrderItemNewPosState();
}

class _OrderItemNewPosState extends State<OrderItemNewPos> {
  List<Orders> _orders = [];
